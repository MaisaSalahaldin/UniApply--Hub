...
//    Universities findUniversitiesNotApplied(int studentId);
    ...
    @Query(value = "SELECT * FROM Universities  WHERE Universities.id NOT IN (SELECT stu_uni.university_id FROM stu_uni  WHERE stu_uni.student_id =?1)", nativeQuery = true)
